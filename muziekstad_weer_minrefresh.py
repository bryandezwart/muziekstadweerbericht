...
def enable_minutely_autorefresh() -> None:
    components.html(
        """
        <script>
        (function() {
            const remaining = 60 * 1000;
        ...
        html_block(
            ...
            <div class="hero">
                ...
                <div class="hero-now">
                    ...
                    <div class="hero-submeta">Laatst bijgewerkt: {updated_text} · Bron: Open-Meteo · Automatische verversing: iedere minuut</div>
                </div>
            </div>
            """
        ),
