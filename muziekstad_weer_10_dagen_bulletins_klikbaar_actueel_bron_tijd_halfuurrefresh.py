...
def enable_halfhour_autorefresh() -> None:
    components.html(
        """
        <script>
        (function() {
            ...
            const remaining = Math.max(1000, nextRefresh - now);
        ...
        html_block(
            ...
            <div class="hero">
                ...
                <div class="hero-now">
                    ...
                    <div class="hero-submeta">Laatst bijgewerkt: {updated_text} · Bron: Open-Meteo · Automatische verversing: elk half uur</div>
                </div>
            </div>
            """
        ),
